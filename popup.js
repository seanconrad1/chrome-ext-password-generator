...
let myCheckbox1 = document.getElementById("special-characters");
let myCheckbox2 = document.getElementById("numbers");
...
function getRandomPassword(obj) {
  myButton.innerHTML = `<svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="clipboard">
...
function handleButtonClick() {
  ...
  // myButton.innerText = "Copied!";
  myButton.innerHTML = `<svg aria-hidden="true" fill="#71db2a" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="success">
